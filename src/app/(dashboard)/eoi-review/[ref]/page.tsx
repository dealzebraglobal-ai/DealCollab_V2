            ...
            <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">
               ...
               <div className="flex items-center gap-4 w-full sm:w-auto">
                  ...
                  <button
                     ...
                     className={`flex-1 sm:flex-none px-12 py-4 rounded-2xl font-bold text-white shadow-xl transition-all flex items-center justify-center gap-2 ${isProcessing ? 'bg-gray-400' : 'bg-[#1F2937] hover:bg-[#F97316] hover:shadow-[#F97316]/20'
                        }`}
                  >
                     {isProcessing ? (
                        <>
